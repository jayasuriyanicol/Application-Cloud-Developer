...
class Persona:
  ...
  #METODI GETTER
    ...
    #Funzone che mi consenta di ritornare il valore diu self.name
    def getName(self) -> str:
        return self.name   

    #Funzone che mi consenta di ritornare il valore diu self.lastname
    def getLastname(self) -> str:
        return self.lastname  
    
    #Funzone che mi consenta di ritornare il valore diu self.age
    def getAge(self) -> str:
        return self.age  
