...
public class ProdottoService {
	...
	public ProdottoResponseDTO trovaProdId(Integer id) {
	 ...
	 Optional<ProdottoResponseDTO>cercaPerNome(String nome){
		 
		 Prodotto p = pr
				 
				 .findByNome(nome)
				 .orElseThrow(() -> new IllegalArgumentException("ATTENZIONE ! Nome con prodotto non esitente"));
		 
		 return Optional.ofNullable(ProdottoMapper.toResponse(p));
	 }
