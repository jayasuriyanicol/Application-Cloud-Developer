...
class ContactManager:
    ...
    def update_phone_number(self, contact_name: str, old_phone_number: str, new_phone_number: str) -> dict[str, list[str]] | str:
        ...
        if new_phone_number in self.contacts[contact_name]:
            return "Errore: il nuovo numero esiste già."
...
print(cm.create_contact("Luca", ["12345"]))
print(cm.add_phone_number("Luca", "67890"))
print(cm.remove_phone_number("Luca", "12345"))
print(cm.update_phone_number("Luca", "67890", "99999"))
print(cm.list_contacts())
print(cm.list_phone_numbers("Luca"))
print(cm.search_contact_by_phone_number("99999"))
